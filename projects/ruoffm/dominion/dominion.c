...
int adventurerfunc(int currentPlayer, struct gameState *state, int drawntreasure, int cardDrawn)
{
	int z=0;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      return adventurerfunc(currentPlayer, state, drawntreasure, cardDrawn);
    ...
    case great_hall:
		return greathallfunc(currentPlayer, state, handPos);
